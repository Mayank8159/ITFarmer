    ...
    const fetchUpdates = async () => {
      try {
        ...
        const url = filter === "all" 
          ? `${API_URL}/updates` 
          : `${API_URL}/updates?category=${filter}`;
        ...
        <div className="relative z-10 max-w-6xl mx-auto px-6 pt-32 pb-32">
          ...
          {isLoading && (
            ...
            >
              ...
              <p className="text-zinc-400 font-mono text-sm uppercase tracking-widest">Loading system feed...</p>
            </motion.div>
          )}
          ...
          {error && !isLoading && (
            <motion.div 
              initial={{ opacity: 0 }} 
              animate={{ opacity: 1 }}
              className="bg-amber-500/10 border border-amber-500/30 p-4 rounded-xl mb-8 text-amber-400 text-sm font-mono uppercase tracking-widest"
            >
              ...
              <AnimatePresence mode="popLayout">
                {updates.length > 0 ? (
                  ...
                  <div className="col-span-full text-center py-20">
                    <p className="text-zinc-500 font-mono text-[10px] uppercase tracking-[0.5em]">No updates found</p>
                  </div>
                )}
              </AnimatePresence>
            </div>
...
function getDemoUpdates(): Update[] {
  return [
    {
      id: "1",
      category: "project",
