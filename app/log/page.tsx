      ...
      <div className="relative z-10 max-w-[1000px] mx-auto px-6">
        ...
        <div className="flex flex-col gap-8 mb-24">
          {logs.map((log, idx) => (
            ...
            >
              <Link href={`/log/${log.id}`} className="block bg-white border-4 border-black p-6 md:p-8 hover:-translate-y-1 hover:translate-x-1 hover:shadow-[12px_12px_0px_0px_rgba(0,0,0,1)] transition-all group">
                <div className="flex flex-col md:flex-row gap-8">
                  ...
                  <div className="flex-1 border-l-0 md:border-l-2 border-black/10 pl-0 md:pl-8">
                    ...
                    <p className="font-mono text-sm text-black/70 leading-relaxed font-bold whitespace-pre-wrap mb-6 line-clamp-3">
                      {log.description}
                    </p>
                    <div className="text-[10px] font-mono font-bold text-black border-2 border-black px-4 py-2 uppercase tracking-widest inline-flex items-center gap-2 group-hover:bg-black group-hover:text-white transition-colors">
